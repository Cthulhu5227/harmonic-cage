...
W  = igl.harmonic(V, F, b, bc, 1) # technically this isn't the exact way we solve in the paper but equivalent, was unable to find solver from og paper
